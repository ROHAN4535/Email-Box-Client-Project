  ...
  const sendEmailHandler = async (event) => {
    ...
    try {
      ...
      const res = await fetch(
        `https://email-box-client-f9178-default-rtdb.firebaseio.com/${senderEmail}/sentemails.json`,
        {
          method: "POST",
          body: JSON.stringify({
            ...emailObj,
    ...
    const emailObj2 = {
      ...
      try {
        ...
        const res = await fetch(
          `https://email-box-client-f9178-default-rtdb.firebaseio.com/${recivedEmail}/recievedemails.json`,
          {
            method: "POST",
            body: JSON.stringify({
              ...emailObj2,
